...
import app.smartsociety.Adapters.MyPagerAdapter;
...
public class Welcome_slider_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layouts = new int[]{R.layout.slider_1, R.layout.slider_3, R.layout.slider_4, R.layout.slider_5, R.layout.slider_6, R.layout.slider_7};
